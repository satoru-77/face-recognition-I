...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #title section
        title_lb1 = Label(bg_img,text="Welcome to Attendance Pannel",font=("Microsoft YaHei UI Light",23,"bold"),bg="#57a1f8",fg="white")
        title_lb1.place(x=500,y=5,width=500,height=50)
        ...
        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Enter Student Details",font=("verdana",12,"bold"),border=0,fg="navyblue")
        ...
        #Improt button
        save_btn=Button(btn_frame,command=self.importCsv,text="Import CSV",width=12,border=0,font=("verdana",12,"bold"),fg="white",bg="#339966")
        save_btn.grid(row=0,column=0,padx=6,pady=10,sticky=W)

        #Exprot button
        update_btn=Button(btn_frame,command=self.exportCsv,text="Export CSV",border=0,width=12,font=("verdana",12,"bold"),fg="white",bg="#339966")
        update_btn.grid(row=0,column=1,padx=6,pady=8,sticky=W)

        #Update button
        del_btn=Button(btn_frame,command=self.action,text="Update",border=0,width=12,font=("verdana",12,"bold"),fg="white",bg="#339966")
        del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",border=0,width=12,font=("verdana",12,"bold"),fg="white",bg="#ff3300")
