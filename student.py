...
class Student:
    def __init__(self,root):
        self.root=root
        self.root.geometry("1366x600+90+100")
    ...
    # This part is image labels setting start 
        # first header image  
        # img=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\banner.jpg")
        ...
        #  # backgorund image 
        bg1=Image.open(r"C:\Users\indra\Documents\Python_Test_Projects\Images_GUI\whitebackground.png")
        bg1=bg1.resize((1366,768),Image.LANCZOS)
        self.photobg1=ImageTk.PhotoImage(bg1)

        # # set image as lable
        bg_img = Label(self.root,image=self.photobg1)
        bg_img.place(x=0,y=0,width=1366,height=600)


        #title section
        title_lb1 = Label(bg_img,text="Welcome to Student Pannel",font=("Microsoft YaHei UI Light",23,"bold"),bg="#57a1f8",fg="white")
        title_lb1.place(x=500,y=5,width=450,height=50)

        # Creating Frame 
        main_frame = Frame(bg_img,bd=2,bg="white") #bd mean border 
        main_frame.place(x=5,y=65,width=1355,height=530)

        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Enter Student Details",font=("verdana",12,"bold"),border=0,fg="#7300e6")
        ...
        dep_combo["values"]=("Select Department","BCA","MCA","CS","IT")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","SE","DBMS","OS","DSA","CN")
        cou_combo.current(0)
        ...
        #Button Frame
        btn_frame = Frame(left_frame,bd=2,bg="white",border=0,relief=RIDGE)
        btn_frame.place(x=10,y=390,width=635,height=60)

        #save button
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=7,border=0, font=("verdana",12,"bold"),fg="white",bg="#339966")
        save_btn.grid(row=0,column=0,padx=5,pady=10,sticky=W)

        #update button
        update_btn=Button(btn_frame,command=self.update_data,text="Update",width=7,border=0,font=("verdana",12,"bold"),fg="white",bg="#339966")
        update_btn.grid(row=0,column=1,padx=5,pady=8,sticky=W)

        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=7,border=0,font=("verdana",12,"bold"),fg="white",bg="#ff3300")
        del_btn.grid(row=0,column=2,padx=5,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=7,border=0,font=("verdana",12,"bold"),fg="white",bg="#ff3300")
        reset_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=9,border = 0,font=("verdana",12,"bold"),fg="white",bg="#339966")
        take_photo_btn.grid(row=0,column=4,padx=5,pady=10,sticky=W)

        #update photo button
        update_photo_btn=Button(btn_frame,text="Update Pic",width=9,border = 0,font=("verdana",12,"bold"),fg="white",bg="#339966")
        ...
        #----------------------------------------------------------------------
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="View Student Details",font=("verdana",12,"bold"),border=0,fg="#7300e6")
        ...
        search_btn=Button(search_frame,command=self.search_data,text="Search",width=9,border=0,font=("verdana",12,"bold"),fg="white",bg="#339966")
        search_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        showAll_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=8,border=0,font=("verdana",12,"bold"),fg="white",bg="#339966")
